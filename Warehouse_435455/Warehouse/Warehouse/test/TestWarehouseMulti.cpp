...
TEST(WarehouseTest, ThreeProducts)
{
    ...
    EXPECT_EQ(
            ...
            R"({"deliveryReport":[{"assignedDepartment":"SmallElectronicDepartment","errorLog":"","productName":"Server Rack","status":"Success"},{"assignedDepartment":"SpecialDepartment","errorLog":"","productName":"Glass Plate","status":"Success"},{"assignedDepartment":"SmallElectronicDepartment","errorLog":"","productName":"Transistor","status":"Success"}]})");

    EXPECT_EQ(
            warehouse.getOccupancyReport(),
            R"({"departmentsOccupancy":[{"departmentName":"SpecialDepartment","maxOccupancy":10,"occupancy":0.5},{"departmentName":"SmallElectronicDepartment","maxOccupancy":10,"occupancy":2.5}]})");
    ...
    {
        auto order = warehouse.newOrder(R"({"order": [{"name":"Glass Plate"}]})");
        EXPECT_EQ(order.receipt, R"({"order": [{"name":"Glass Plate"}]})");
        EXPECT_EQ(order.products.back().get(), rawProductPtr2);
    }

    {
        auto order = warehouse.newOrder(R"({"order": [{"class":"ElectronicParts","name":"Transistor"}]})");
        EXPECT_EQ(order.receipt, R"({"order": [{"class":"ElectronicParts","name":"Transistor"}]})");
...
TEST(WarehouseTest, IceCreams)
{
    ...
    EXPECT_EQ(
            warehouse.newDelivery(std::move(products)),
            R"({"deliveryReport":[{"assignedDepartment":"ColdRoomDepartment","errorLog":"","productName":"0","status":"Success"},{"assignedDepartment":"ColdRoomDepartment","errorLog":"","productName":"1","status":"Success"},{"assignedDepartment":"ColdRoomDepartment","errorLog":"","productName":"2","status":"Success"},{"assignedDepartment":"ColdRoomDepartment","errorLog":"","productName":"3","status":"Success"}]})");

    EXPECT_EQ(warehouse.getOccupancyReport(),
              R"({"departmentsOccupancy":[{"departmentName":"ColdRoomDepartment","maxOccupancy":10,"occupancy":8}]})");
    {
    ...
    }
    {
        ...
        EXPECT_EQ(warehouse.getOccupancyReport(),
                  R"({"departmentsOccupancy":[{"departmentName":"ColdRoomDepartment","maxOccupancy":10,"occupancy":0}]})");
    }
    {
        auto order = warehouse.newOrder(R"({"order": [{"class":"AstronautsIceCream"}]})");
...
TEST(WarehouseTest, ProductAll)
{
    ...
    EXPECT_EQ(
            warehouse.newDelivery(std::move(products)),
            R"({"deliveryReport":[{"assignedDepartment":"SpecialDepartment","errorLog":"","productName":"Glass Plate","status":"Success"},{"assignedDepartment":"SmallElectronicDepartment","errorLog":"","productName":"Transistor","status":"Success"},{"assignedDepartment":"OverSizeElectronicDepartment","errorLog":"","productName":"Server Rack","status":"Success"},{"assignedDepartment":"HazardousDepartment","errorLog":"","productName":"1 gal","status":"Success"},{"assignedDepartment":"HazardousDepartment","errorLog":"","productName":"100l","status":"Success"},{"assignedDepartment":"SpecialDepartment","errorLog":"","productName":"Brave","status":"Success"},{"assignedDepartment":"ColdRoomDepartment","errorLog":"","productName":"2","status":"Success"}]})");

    EXPECT_EQ(
            warehouse.getOccupancyReport(),
            R"({"departmentsOccupancy":[{"departmentName":"SpecialDepartment","maxOccupancy":1000,"occupancy":40.5},{"departmentName":"ColdRoomDepartment","maxOccupancy":1000,"occupancy":2},{"departmentName":"HazardousDepartment","maxOccupancy":1000,"occupancy":150},{"departmentName":"SmallElectronicDepartment","maxOccupancy":1000,"occupancy":0.5},{"departmentName":"OverSizeElectronicDepartment","maxOccupancy":1000,"occupancy":6}]})");
    ...
    {
        auto order = warehouse.newOrder(R"({"order": [{"class":"ExplosiveBarrel"}]})");
        EXPECT_EQ(order.products.back().get(), productsRawPtrs[4]);
    }
    {
        auto order = warehouse.newOrder(R"({"order": [{"class":"TV"}]})");
