...
public:
    ...
    IDepartment() = default;
    IDepartment(const IDepartment &) = delete;
    IDepartment &operator=(const IDepartment &) = delete;
    IDepartment(IDepartment &&) = delete;
    IDepartment &operator=(IDepartment &&) = delete;
    ...
    /**
     * @brief The function converts stored objects in departments to JSON array object.
